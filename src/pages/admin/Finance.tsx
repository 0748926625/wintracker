...
export default function AdminFinance() {
  ...
  const summary = useMemo(() => {
    ...
    for (const p of packages) {
      ...
      if (!mf.inRange(p.created_at)) continue
  ...
  return (
    <div>
      ...
      <p className="mt-4 text-xs text-gray-400">
        Montants en FCFA, calculés sur les colis livrés avec succès du mois sélectionné uniquement.
      </p>
    </div>
  )
}
